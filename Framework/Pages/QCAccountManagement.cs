...
namespace SeleniumFramework
{
    public class QCAccountManagement
    {
        ...
        private void ProcessAddNewQCAccountPage1(DataRow dr)
        {
            ...
            {
                string qccNum = "";
                qccNum = Faker.RandomNumber.Next(10000, 99999).ToString() + Faker.RandomNumber.Next(10000, 99999).ToString();
                ...
                dr["QCCCNum"] = (dr["QCCCNum"].ToString().ToLower() == "auto" ? qccNum : dr["QCCCNum"]); 
